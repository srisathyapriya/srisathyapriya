...
```javascript
const sriSathyaPriya = {
  name:              "R. Sri Sathya Priya",
  location:          "Tamil Nadu, India 🇮🇳",
  degree:            "B.E. (ECE) — Sri Eshwar College of Engineering",
  cgpa:              8.39,
  ...
  research: "Book chapter author — AI Cybersecurity & UAV Systems 📖",

  funFact: "I once debugged a REST API at 2 AM and it worked. 🌙",

  motto: () => "Build. Test. Ship. Repeat. 🚀"
};
```
...
![DSA](https://img.shields.io/badge/Data%20Structures-BF91F3?style=flat-square&logoColor=white)
![DBMS](https://img.shields.io/badge/DBMS-38BDAE?style=flat-square&logoColor=white)
![Software Testing](https://img.shields.io/badge/Software%20Testing-E34F26?style=flat-square&logoColor=white)
...
- 🔧 Developed full-stack web applications using the MERN stack with emphasis on API integration and database connectivity
- 🎨 Built responsive user interfaces that delivered smooth cross-device experience
- 🤝 Collaborated in a team environment, practising agile workflows and peer code reviews
- 🧪 Gained hands-on experience in backend development, application testing, and modern web technologies
...
- 🤖 Completed hands-on training in embedded systems, AI, and IoT concepts under industry experts
- ⚙️ Gained practical exposure to system design and problem-solving through real-world project implementation
- 🏭 Worked on industry-oriented exercises that bridged academic knowledge and applied engineering
- 🔍 Explored integration of AI capabilities into hardware-level systems and IoT architectures
...
|:------:|:-----------:|:----:|:-----:|
| **B.E. — Electronics & Communication Engineering** | Sri Eshwar College of Engineering | 2022 – 2026 | CGPA: **8.39** |
| **HSC (Class XII)** | Bharathiya Vidhya Mandir Matric Hr. Sec School | 2020 – 2022 | **92.67%** |
| **SSLC (Class X)** | Bharathiya Vidhya Mandir Matric Hr. Sec School | 2019 – 2020 | **88.6%** |
